...
comparable to the latter. Relevant work in this direction includes \citep{gutmann2012noise,cranmer2015approximating,cranmer2016experiments,2016arXiv161110242D,gutmann2017likelihood}.
...
\end{eqnarray}
and variational inference with the KL distance corresponds to $(O^{p,q} f) = \log q(z) - \log p(z|x) \, \forall f \in \mathcal{F}$.
