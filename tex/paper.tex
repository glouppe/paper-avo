...
\begin{figure}
    ...
    \caption{Toy problem on discrete data: Poisson with unknown scale.
             This example illustrates the effectiveness of adversarial variational optimization on discrete non-differentiable generators.}\label{fig:poisson}
\end{figure}
...
otherwise left unchanged. Despite the discreteness and the non-differentiability
