...
in the top right plot of  Figure~\ref{fig:poisson}, with again
slighlty better results for the entropy penalized model. This suggests either a
...
Effectively, the procedure results in learning an abitrarily tight proposal
