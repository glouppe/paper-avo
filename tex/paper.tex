...
We assume that the stochastic generative process that defines $p(\mathbf{x}|\bfz,\bftheta)$ is
specified through a deterministic function $g(\cdot; \bftheta) : {\cal Z} \to
