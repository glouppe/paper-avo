...
\begin{figure}
    ...
    \caption{Discrete Poisson model with unknown scale.
             ...
             (Top right) Model distributions $p(\mathbf{x}|\psi)$ after training. This plot shows that the resulting parameterizations of the simulator closely reproduce the true distribution with, in this case, qualitatively
                        better results for the penalized model.
