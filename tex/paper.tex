...
As illustrative experiments, we evaluate in this section adversarial variational
optimization on well-known distributions for continuous and discrete data.

We first consider inference for a univariate Gaussian with unknown mean and
...
\begin{figure}
    ...
    \caption{\glnote{todo}}\label{fig:gaussian}
\end{figure}
...
Similarly, ... \glnote{discrete case with a Poisson distribution.}
