...
The top left plot in Figure~\ref{fig:weinberg} illustrates the resulting proposal
...
in the top right plot of  Figure~\ref{fig:weinberg}, with again
slightly better results for the entropy penalized model. This suggests either a
...
The authors would like to thank Lukas Heinrich for helpful comments regarding
