...
\begin{figure}
    ...
    \caption{Multidimensional continuous data.
             ...
             ({\it Right}) Likelihood $q(\theta|\psi)$ after adversarial variational optimization. The proposal density correctly concentrates around $\theta^* = (1, -1)$.
             }\label{fig:multi}
\end{figure}
...
adversarial variational optimization. We see that the distributions both arrive
in the neighborhood of $\theta^*$, with a density highly more concentrated for
...
and the parameters $\theta$, this example demonstrates once again the efficacy
of adversarial variational optimization for parameter inference on black box
simulator.
