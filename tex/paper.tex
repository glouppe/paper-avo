...
In this note, we develop a likelihood-free inference algorithms 
non-differentiable, implicit generative mode. The first allows us 
...
Moreover, the algorithm could be adapted to use estimates to the KL distance~\citep{perez2009estimation} without the adversarial optimization for the critic. These variants may be particularly useful for small $N$.
