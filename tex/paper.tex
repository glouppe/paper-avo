...
\begin{figure}
    ...
    \caption{Multidimensional continuous data.
             ...
             ({\it Right}) Density $q(\theta|\psi)$ after adversarial variational optimization. The proposal density correctly converges towards a distributon whose density concentrates around $\theta^* = (1, -1)$.
             }\label{fig:multi}
\end{figure}
...
of adversarial variational optimization for parameter inference on a black box
simulator.
