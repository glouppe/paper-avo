...
algorithm~\citep{2011arXiv1106.4487W} or of variance reduction techniques~\citep{ranganath2014black}.
...
direction includes those that rely on a classifier to estimate the discrepancy betwen the observed data and the model distributions
