...
languages, hence raising raising the bar for likelihood-free inference
...
\glnote{Compare with gradient-free optimization.}

\glnote{Wood -> assume that the simulator is probabilistic program.}
\glnote{Storkey -> assume access to derivatives.}
