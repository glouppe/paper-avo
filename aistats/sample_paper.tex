...
\aistatstitle{Adversarial Variational Optimization of\\
              Non-Differentiable Simulators}

\aistatsauthor{Author 1 \And Author 2}
\aistatsaddress{Institution 1 \And Institution 2}

% \aistatsauthor{Gilles Louppe \And Kyle Cranmer}
%
% \aistatsaddress{New York University\\
...
Wasserstein GANs~\cite{2017arXiv170107875A} reformulate the adversarial
...
algorithm~\cite{2011arXiv1106.4487W} or variance reduction techniques
such as Rao-Blackwellization,
Control Variates, or quasi-Monte Carlo~\cite{ranganath2014black, tran2017variational}.
...
\cite{cranmer2015approximating}. More specifically, we consider the following
generative process:
\begin{itemize}
...
generative adversarial networks~\cite{goodfellow2014generative,2017arXiv170104862A, 2017arXiv170107875A} to
...
require restrictive assumptions.  In \cite{tran2017variational}, the authors
