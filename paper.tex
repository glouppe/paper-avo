...
difficult, as simulators rarely provide a way to evaluate the likehood
...
generate data. Because it is usually computationally intractable, simulators
often do not provide a way to directly evaluate the likelihood function for a
...
\glnote{Mention that we use WGAN-GP in this note, but that the VO procedure can be coupled other vairants of GANs.}
