...
Following \citep{2012arXiv1212.4507S}, variational optimization (VO) is a general
...
\glnote{Consider instead natural evolution strategies, which should be more stable?}
\glnote{Rewrite in terms of NES!!}
